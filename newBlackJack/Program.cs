            ...
            do
            {
                ...
                switch (goFirst)
                {
                    case 0:
                        ...
                        if (player1[0].znachenie == znachenie.tuz && player1[1].znachenie == znachenie.tuz
                            && computer[0].znachenie == znachenie.tuz && computer[1].znachenie == znachenie.tuz)
                        {
